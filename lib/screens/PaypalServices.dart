...
class PaypalServices {
  ...
  String clientId = SharedPreferenceUtil.getString(Constants.appPaypal_client_id); // from api
  String secret = SharedPreferenceUtil.getString(Constants.appPaypal_secret_key); // from api
